...
N -380 -300 -330 -300 {lab=#net1}
N -380 -240 -330 -240 {lab=VICM}
N -130 -270 -80 -270 {lab=Vout}
N 10 -440 10 -270 {lab=Vout}
N -460 -440 -460 -300 {lab=#net1}
N -460 -500 -460 -440 {lab=#net1
}
...
C {devices/code.sym} -930 -400 0 0 {name=STB_SIMS only_toplevel=true 
value="
