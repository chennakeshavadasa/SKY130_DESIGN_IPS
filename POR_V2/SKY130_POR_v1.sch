...
C {devices/code.sym} 140 -510 0 0 {name=SAVE_COMM only_toplevel=true 
value="
...
spiceprefix=X
mult=1}
C {devices/code.sym} -120 -660 0 0 {name=TRAN_SIMS only_toplevel=true 
value="
.option wnflag=1 gmin=1e-18
.option savecurrents
.temp 27
...
C {devices/code.sym} 10 -510 0 0 {name=TEMP_SIMS only_toplevel=true 
value="
.option wnflag=1 gmin=1e-18
.option savecurrents
.temp 27
